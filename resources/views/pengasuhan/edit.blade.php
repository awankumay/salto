...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between">
        {{ Breadcrumbs::render('pengasuhan.edit', $pengasuhan) }}
    </div>
    <div class="card table col-md-12 px-1 py-1" style="background-color: #fdfdfd !important;">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <div class="p-2">Ubah Pengasuhan</div>
                <a class="btn btn-sm btn-warning" href="{{route('pengasuhan.index')}}">Kembali</a>
            </div>
        </div>
        <div class="card-body">
            {!! Form::model($pengasuhan, ['method' => 'PATCH','route' => ['pengasuhan.update', $pengasuhan->id], 'enctype' => 'multipart/form-data']) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group col-md-6">
                        <input type="hidden" name="id_user" value="{{Auth::user()->id}}">
                        <input type="hidden" name="keluarga_asuh_id" value="{{$pengasuhan->keluarga_asuh_id}}">
                        <input type="hidden" name="keluarga_asuh" value="{{$pengasuhan->keluarga_asuh}}">
                        <strong>Judul:</strong>
                ...
                <div class="col-md-12">
                    <div class="form-group col-md-6">
                        ...
                        <input type="datetime-local" class="form-control form-control-sm $x" name="start_time" value="{{$pengasuhan->start_time}}">
                ...
                <div class="col-md-12">
                    <div class="form-group col-md-6">
                        ...
                        <input type="datetime-local" class="form-control form-control-sm $x" name="end_time" value="{{$pengasuhan->end_time}}">
