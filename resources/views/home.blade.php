...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="card border-left-default shadow h-100 py-2 col-md-12">
            <div class="card-body">
                <h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-fw fa-university text-success"></i> Dashboard</h1>
            </div>
        </div>
            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Napi</div>
