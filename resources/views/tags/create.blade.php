            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group col-md-4">
                        ...
                        {!! Form::text('name', null, array('placeholder' => 'Nama Tags','class' => 'form-control form-control-sm '.$x.'')) !!}
                        <span class="form-text {{isset($errors->messages()['name']) ? 'text-danger text-help' : 'text-muted text-help'}}">
                        {{isset($errors->messages()['name']) ? $errors->messages()['name'][0] .'*' : 'Nama tags wajib diisi *'}}
                        </span>
                    </div>
                </div>
