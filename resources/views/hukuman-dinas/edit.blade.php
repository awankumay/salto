...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between">
        {{ Breadcrumbs::render('hukuman-dinas.edit', $hukdis) }}
    </div>
    <div class="card table col-md-12 px-1 py-1" style="background-color: #fdfdfd !important;">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <div class="p-2">Ubah Hukuman</div>
                <a class="btn btn-sm btn-warning" href="{{route('hukuman-dinas.index')}}">Kembali</a>
            </div>
        </div>
        <div class="card-body">
            {!! Form::model($hukdis, ['method' => 'PATCH','route' => ['hukuman-dinas.update', $hukdis->id], 'enctype' => 'multipart/form-data']) !!}
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group col-md-6">
                        <strong>Nama Taruna:</strong>
                        <select class="taruna form-control form-control-sm" name="id_taruna">
                ...
                <div class="col-md-12">
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::select('tingkat', $tingkat, $hukdis->tingkat, array('class' => 'form-control form-control-sm','single', 'placeholder'=>'Pilih Tingkat')) !!}
                ...
                <div class="col-md-12">
                    <div class="form-group col-md-6">
                        ...
                        <input type="datetime-local" class="form-control form-control-sm $x" name="start_time" value="{{$hukdis->start_time}}">
                ...
                <div class="col-md-12">
                    <div class="form-group col-md-6">
                        ...
                        <input type="datetime-local" class="form-control form-control-sm $x" name="end_time" value="{{$hukdis->end_time}}">
