...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between">
        {{ Breadcrumbs::render('grade.edit', $grade) }}
    </div>
    <div class="card table col-md-12 px-1 py-1" style="background-color: #fdfdfd !important;">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <div class="p-2">Ubah Kategori Grade</div>
                <a class="btn btn-sm btn-warning" href="{{route('grade.index')}}">Kembali</a>
            </div>
        </div>
        <div class="card-body">
            {!! Form::model($grade, ['method' => 'PATCH','route' => ['grade.update', $grade->id], 'enctype' => 'multipart/form-data']) !!}
            <div class="row">
                <div class="col-md-12">
